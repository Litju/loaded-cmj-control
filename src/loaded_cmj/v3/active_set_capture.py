...
class ActiveSetRecorder:
    ...
    def finalize(self) -> V3ActiveSetTables:
        ...
        tables = V3ActiveSetTables(
            ...
            contact_id=np.asarray(self._columns.get("contact_id", []), dtype=np.int64),
            contact_geom0_id=np.asarray(self._columns.get("contact_geom0_id", []), dtype=np.int32),
            contact_geom1_id=np.asarray(self._columns.get("contact_geom1_id", []), dtype=np.int32),
            contact_class=np.asarray(self._columns.get("contact_class", []), dtype=np.int8),
            contact_side=np.asarray(self._columns.get("contact_side", []), dtype=np.int8),
            contact_region=np.asarray(self._columns.get("contact_region", []), dtype=np.int8),
            contact_dist=np.asarray(self._columns.get("contact_dist", []), dtype=np.float64),
            contact_pos=np.asarray(self._columns.get("contact_pos", []), dtype=np.float64).reshape(-1, 3),
            contact_frame=np.asarray(self._columns.get("contact_frame", []), dtype=np.float64).reshape(-1, 9),
            contact_efc_address=np.asarray(self._columns.get("contact_efc_address", []), dtype=np.int32),
            contact_dim=np.asarray(self._columns.get("contact_dim", []), dtype=np.int32),
            contact_efc_nrows=np.asarray(self._columns.get("contact_efc_nrows", []), dtype=np.int32),
            contact_force6=np.asarray(self._columns.get("contact_force6", []), dtype=np.float64).reshape(-1, 6),
            contact_normal_force=np.asarray(self._columns.get("contact_normal_force", []), dtype=np.float64),
            contact_active=np.asarray(self._columns.get("contact_active", []), dtype=np.bool_),
            contact_legal_active=np.asarray(self._columns.get("contact_legal_active", []), dtype=np.bool_),
            contact_prohibited=np.asarray(self._columns.get("contact_prohibited", []), dtype=np.bool_),
            efc_offsets=efc_offsets,
            efc_type=np.asarray(self._columns.get("efc_type", []), dtype=np.int8),
            efc_id=np.asarray(self._columns.get("efc_id", []), dtype=np.int32),
            efc_state=np.asarray(self._columns.get("efc_state", []), dtype=np.int8),
            efc_pos=np.asarray(self._columns.get("efc_pos", []), dtype=np.float64),
            efc_vel=np.asarray(self._columns.get("efc_vel", []), dtype=np.float64),
            efc_force=np.asarray(self._columns.get("efc_force", []), dtype=np.float64),
            efc_margin=np.asarray(self._columns.get("efc_margin", []), dtype=np.float64),
            efc_aref=np.asarray(self._columns.get("efc_aref", []), dtype=np.float64),
            efc_b=np.asarray(self._columns.get("efc_b", []), dtype=np.float64),
            efc_d=np.asarray(self._columns.get("efc_d", []), dtype=np.float64),
            efc_kbip=np.asarray(self._columns.get("efc_kbip", []), dtype=np.float64).reshape(-1, 4),
            efc_frictionloss=np.asarray(self._columns.get("efc_frictionloss", []), dtype=np.float64),
            efc_jacobian=np.asarray(self._columns.get("efc_jacobian", []), dtype=np.float64).reshape(
