...
# --------------------------------------------------------------------------
# V2.1 True-Standing Recovery Contract (RES-43 rebase)
# Frozen empirical neighborhood derived from qualified 2.0 s standing hold
# on the honest zero-limit, zero-root-damping planar Plant sealed by RES-42.
# See LCMJ-V2_1-RES43-TRUE-STANDING-REBASE-20260901 / 02_ZERO_DAMPING_STANDING_TRACE.json / 05_NEW_STANDING_ENVELOPE.json
# RES-42 proved OLD_TRUE_STANDING_REFERENCE_STILL_VALID=NO (old envelope 2.1-true-standing-recovery-v1 invalid).
# --------------------------------------------------------------------------
V2_EVENT_CONTRACT_VERSION = "2.1-true-standing-zero-root-damping-v2"

V2_TRUE_STANDING_REFERENCE = MappingProxyType({
    "Q_STAND_REF": (-7.758837685384293e-05, 4.882253807023157e-05, 4.882253807023082e-05, -1.422155659242649e-05, -1.4221556592427106e-05, 0.00015380846291127736, 0.00015380846291127126),
    "COM_Z_STAND_REF": 1.0748482248649802,
    "ROOT_Z_STAND_REF": 0.8999333816609396,
    "TRUNK_PITCH_STAND_REF": 0.000414232556056533,
    "provenance": "componentwise median over [SUPPORTED_START_CONFIRMED_AT=0.10012500000000008, 2.0] (15200 physics samples, HOLD Kp400 Kd10, V2Plant zero-damping, MuJoCo 3.8.0)",
})
...
V2_TRUE_STANDING_ENVELOPE = MappingProxyType({
    ...
    "Q_STAND_MIN": (-0.0010646233267473013, -6.015562677118107e-05, -6.015562677117834e-05, -0.00014991030670825437, -0.00014991030670825434, -8.092467744017705e-05, -8.092467744017095e-05),
    "Q_STAND_MAX": (0.00011071707376190296, 0.0006449640776937647, 0.0006449640776937637, 5.819712849261686e-05, 5.819712849261647e-05, 0.001443466858333388, 0.0014434668583333844),
    # Expanded by exactly one ULP via np.nextafter for floating equality guard
    "Q_STAND_ENVELOPE": (
        (-0.0010646233267473015, 0.00011071707376190298),
        (-6.0155626771181074e-05, 0.0006449640776937648),
        (-6.015562677117835e-05, 0.0006449640776937638),
        (-0.0001499103067082544, 5.819712849261687e-05),
        (-0.00014991030670825437, 5.8197128492616475e-05),
        (-8.092467744017706e-05, 0.0014434668583333881),
        (-8.092467744017096e-05, 0.0014434668583333846),
    ),
    "COM_Z_STAND_MIN": 1.074845752144528,
    "COM_Z_STAND_MAX": 1.074848972560983,
    "COM_Z_STAND_ENVELOPE": (1.0748457521445278, 1.0748489725609833),
    "ROOT_Z_STAND_MIN": 0.8999321174938333,
    "ROOT_Z_STAND_MAX": 0.8999341097075043,
    "ROOT_Z_STAND_ENVELOPE": (0.8999321174938332, 0.8999341097075044),
    "TRUNK_PITCH_STAND_MIN": 2.1073424255447017e-08,
    "TRUNK_PITCH_STAND_MAX": 0.003425251594831574,
    "TRUNK_PITCH_STAND_ENVELOPE": (2.1073424255447014e-08, 0.0034252515948315744),
