...
from loaded_cmj.runtime.policy_spec import POLICY_PROTOCOL_VERSION

from loaded_cmj.runtime.errors import PolicyProtocolError
from loaded_cmj.runtime.numeric import validate_finite_tree
...
def _decode_untrusted_response_text(raw: str | bytes, *, max_bytes: int) -> str:
    ...
    exceptions that the rollout runtime may classify as trusted infrastructure failures.
    """
