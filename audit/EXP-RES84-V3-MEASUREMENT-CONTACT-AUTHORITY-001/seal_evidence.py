#!/usr/bin/env python3
"""Seal the RES-84 evidence bundle into the external evidence root.

Follows the RES-82 / RES-83 / RES-95 convention:
...
def seal_external() -> dict:
    ...
    seal = {
        ...
        "LINEAR_ISSUE": "RES-84",
        "ACHIEVEMENT": "V3 measurement/contact authority rebuilt and sealed on the RES-83 Plant",
